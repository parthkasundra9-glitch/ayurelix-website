      ...
      <section className="max-w-7xl mx-auto py-32 px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          >
            ...
            <div className="bg-[#c5a059]/5 border-l-4 border-[#c5a059] rounded-r-2xl p-6 space-y-3">
              <h3 className="text-sm font-bold uppercase tracking-wider text-[#0e1a30]">
                ⚠️ MEDICAL & HEALTH DISCLAIMER (CRITICAL)
              </h3>
              <p className="text-xs leading-relaxed text-slate-700 font-medium">
                The content provided on this website, including product descriptions, blog posts, ingredient guides, and the results of our Dosha Quiz, is for informational and educational purposes only. It is not intended as a substitute for professional medical advice, diagnosis, or treatment. 
              </p>
              <p className="text-xs leading-relaxed text-slate-700 font-medium">
