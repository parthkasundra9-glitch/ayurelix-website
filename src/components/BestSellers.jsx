          ...
          {bestsellers.map((product) => {
            ...
            return (
              <motion.div
                ...
                className="w-[280px] sm:w-[320px] shrink-0 group cursor-pointer bg-[#FAF8F5] border border-[#3C5A44]/5 hover:border-[#B89355]/40 rounded-3xl p-4 transition-all duration-500 shadow-sm hover:shadow-xl flex flex-col justify-between"
              >
                <div>
                  {/* Visual Image */}
