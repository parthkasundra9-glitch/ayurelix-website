          ...
          >
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                ...
                <li>
                  <strong>Custom Dosha Blends:</strong> Any formulation blended custom-tailored to your Ayurvedic Dosha profile (following the online assessment) is unique to you and cannot be returned.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p>
                We immediately replace items if they are received damaged, broken, or defective. Please contact us at <a href="mailto:support@ayurelix.com" className="text-[#c5a059] font-bold underline">support@ayurelix.com</a> within <strong>48 hours</strong> of delivery with:
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                <li>Send an email to <a href="mailto:support@ayurelix.com" className="text-[#0e1a30] underline">support@ayurelix.com</a> with your order details and reason for return.</li>
