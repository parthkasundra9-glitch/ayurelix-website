        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                <li>Send an email to <a href="mailto:ayurelix512@gmail.com" className="text-[#1A2B49] underline">ayurelix512@gmail.com</a> with your order details and reason for return.</li>
